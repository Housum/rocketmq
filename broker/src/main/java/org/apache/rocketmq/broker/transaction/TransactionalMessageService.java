...
/**
 * 事务消息处理类 使用的是2PC+反查补偿的方式(状态不确定的)
 *
...
public interface TransactionalMessageService {
     ...
     * 事务第一阶段,该阶段的时候消息并没有设置指定的topic,而是放在了org.apache.rocketmq.common.MixAll#RMQ_SYS_TRANS_HALF_TOPIC这个topic中
     * 后面第二阶段之后才会将其放入到指定的topic中
     *
